...
- 🌱 I’m ya boi living in the Philippines. <img style="margin: 12px" src="https://profilinator.rishav.dev/skills-assets/python-original.svg" alt="Python" height="15" /> and Shell scripting in Linux <img style="margin: 12px" src="https://profilinator.rishav.dev/skills-assets/linux-original.svg" alt="Linux" height="15" /> .

- ^^^ - i haven't been consistent in doing those anymore. 
<!---
